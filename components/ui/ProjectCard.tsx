...
const ProjectCard = ({ title, description, category, techStack, onClick }: ProjectCardProps) => {
  return (
    <StyledWrapper onClick={onClick}>
      <div className="parent" style={{ cursor: onClick ? 'pointer' : 'default' }}>
        <div className="card">
          <div className="logo">
          ...
          <div className="bottom">
            <div className="social-buttons-container" style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
              ...
              {techStack && (
                <div className="tech-stack-preview">
                  ...
                  {techStack.length > 2 && <span className="tech-pill">+{techStack.length - 2}</span>}
                </div>
              )}
            </div>
...
const StyledWrapper = styled.div`
  ...
  .bottom .social-buttons-container .category-badge {
  ...
  .bottom .social-buttons-container .tech-stack-preview {
    display: flex;
    gap: 4px;
    flex-wrap: wrap;
  }

  .bottom .social-buttons-container .tech-pill {
  ...
  .parent:hover .card .bottom .social-buttons-container {
